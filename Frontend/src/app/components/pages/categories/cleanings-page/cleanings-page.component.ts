...
@Component({
  selector: 'app-cleanings-page',
  templateUrl: './cleanings-page.component.html',
  styleUrls: ['./cleanings-page.component.css']
})
export class CleaningsPageComponent implements OnInit {
